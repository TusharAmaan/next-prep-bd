...
const UserManagementTable = memo(({ users, onRoleUpdate, onInviteClick, onDeleteUser }: any) => {
    const getRoleColor = (r: string) => {
        switch (r) {
            ...
            case 'institute': return 'bg-purple-100 text-purple-700 border-purple-200';
            case 'tutor': return 'bg-emerald-100 text-emerald-700 border-emerald-200';
...
export default function AdminDashboard() {
    ...
    const handleSave = async () => {
        ...
        if (activeTab === 'materials') {
            ...
            else if (type === 'question') { payload.content_body = content; payload.category = category; } // SAVING CATEGORY FOR QUESTION
        ...
        <div className="flex min-h-screen bg-[#F8FAFC] font-sans text-slate-900 pt-32">
            ...
            <main className="flex-1 md:ml-64 p-8 overflow-x-hidden min-h-screen">
                <div className="max-w-[1800px] mx-auto w-full">
                    {!editorMode && activeTab !== 'hierarchy' && activeTab !== 'users' && (
                        <ListHeader
                    ...
                    {/* OTHER LIST VIEWS */}
                    {activeTab !== 'categories' && activeTab !== 'hierarchy' && activeTab !== 'users' && !editorMode && (
                        <div className="animate-fade-in space-y-6">
                            <FilterBar
