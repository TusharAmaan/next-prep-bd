    ...
    const fetchDashboardData = useCallback(async () => {
        ...
        try {
            ...
            const rawActivities = [
                ...
                ...(recentCourses.data || []).map(c => ({ type: 'course', title: c.title, action: 'New Course', created_at: c.created_at })),
                ...(recentEbooks.data || []).map(e => ({ type: 'ebook', title: e.title, action: 'New Ebook', created_at: e.created_at })),
