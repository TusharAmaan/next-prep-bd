    ...
    <>
      ...
      <div className="min-h-screen bg-white dark:bg-slate-950 font-sans transition-colors duration-500 overflow-x-hidden">
        ...
        <section className="relative pt-32 pb-20 md:pt-60 md:pb-48 px-4 md:px-6 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="flex flex-col items-center text-center">
                ...
                <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold text-slate-900 dark:text-white mb-8 md:mb-10 tracking-tight leading-[1] md:leading-[1.1] animate-in fade-in slide-in-from-bottom-8 duration-1000">
        ...
        <section className="py-24 md:py-44 max-w-7xl mx-auto px-4 md:px-6">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-16 md:mb-24 gap-8 md:gap-12 text-center md:text-left">
            <div className="space-y-4">
              <span className="text-indigo-600 dark:text-indigo-400 font-bold tracking-widest text-[11px]">Academic Framework</span>
              <h2 className="text-3xl md:text-5xl lg:text-7xl font-bold text-slate-900 dark:text-white tracking-tight leading-[1] md:leading-[1.1]">
        ...
        <section className="py-24 md:py-44 bg-slate-50 dark:bg-slate-900/30 relative border-y border-slate-100 dark:border-slate-800/50">
          <div className="max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-32 items-center">
             <div className="space-y-8 md:space-y-12 text-center md:text-left">
                <div className="space-y-4">
                  <span className="text-amber-600 dark:text-amber-500 font-bold tracking-widest text-[11px]">What Sets Us Apart</span>
                  <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-slate-900 dark:text-white tracking-tight leading-[1] md:leading-[1.1]">
                   ...
                   <div className="space-y-6 md:space-y-10">
                      ...
                      <div className="grid grid-cols-2 gap-4 md:gap-6">
                         <div className="p-6 md:p-8 bg-slate-50 dark:bg-slate-800 rounded-2xl md:rounded-[2.5rem] border border-slate-100 dark:border-slate-700 text-center">
                            ...
                            <p className="text-[9px] font-bold tracking-widest text-slate-400">Founded 2024</p>
                         </div>
                         <div className="p-6 md:p-8 bg-slate-50 dark:bg-slate-800 rounded-2xl md:rounded-[2.5rem] border border-slate-100 dark:border-slate-700 text-center">
                            <Flag className="w-6 h-6 md:w-8 md:h-8 text-cyan-600 mx-auto mb-3 md:mb-4" />
                            <p className="text-[9px] font-bold tracking-widest text-slate-400">Trusted Nationwide</p>
                         </div>
                      </div>
                   </div>
                </div>
        ...
        <section className="py-24 md:py-44 max-w-7xl mx-auto px-4 md:px-6 text-center">
           <h2 className="text-3xl md:text-6xl font-bold mb-16 md:mb-24 tracking-tight leading-tight md:leading-none text-slate-900 dark:text-white">Success for <br className="md:hidden"/> <span className="text-indigo-600 dark:text-indigo-400">Every Candidate.</span></h2>
