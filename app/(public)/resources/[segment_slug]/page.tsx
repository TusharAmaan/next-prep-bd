        ...
        <section className="max-w-7xl mx-auto px-6 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
              ...
              <div className="lg:col-span-8 space-y-24">
                  ...
                  {groups && groups.length > 0 && (
                      <section>
                          <div className="flex items-center gap-4 mb-10">
                              ...
                              <h2 className="text-3xl font-black uppercase tracking-tighter">Academic Segments</h2>
                          </div>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                              {groups.map((group: any, index: number) => {
                                  const style = getGroupStyle(index);
                                  return (
                                      <Link key={group.id} href={`/resources/${segment_slug}/${group.slug}`} className={`group bg-white dark:bg-slate-900 p-6 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 hover:shadow-2xl dark:hover:shadow-indigo-900/10 hover:-translate-y-2 transition-all duration-500 relative overflow-hidden flex items-center gap-6`}>
                                          <div className={`w-20 h-20 rounded-2xl ${style.bg} text-white flex items-center justify-center text-4xl font-black shadow-2xl shrink-0 group-hover:scale-110 transition-transform duration-500`}>
                                              {group.title.charAt(0)}
                                          </div>
                                          <div className="flex-1 min-w-0">
                                              <h3 className={`text-2xl font-black uppercase tracking-tight mb-2 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors`}>{group.title}</h3>
                  ...
                  <section>
                      <div className="flex items-center gap-3 mb-10 px-6 py-4 bg-indigo-500/5 dark:bg-indigo-500/10 rounded-3xl border border-indigo-500/10 w-fit">
                          <Sparkles className="w-5 h-5 text-amber-500 fill-amber-500 animate-pulse"/> 
                          <span className="text-[10px] font-black uppercase tracking-widest text-indigo-600 dark:text-indigo-400">Institutional Updates</span>
                      </div>
                      
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                          <Link href={`/resources/${segment_slug}?type=update&category=Routine`} className="relative group overflow-hidden rounded-[2.5rem] p-8 flex flex-col justify-between h-52 bg-gradient-to-br from-blue-500 to-indigo-700 shadow-2xl shadow-blue-500/20 hover:-translate-y-2 transition-all duration-500">
                              <div className="absolute right-[-20px] bottom-[-20px] opacity-10 transform rotate-12 group-hover:scale-125 group-hover:rotate-0 transition-all duration-700">
                                  <CalendarDays className="w-48 h-48 text-white" />
                              </div>
                              <div className="relative z-10">
                                  <div className="w-12 h-12 rounded-2xl bg-white/10 backdrop-blur-xl flex items-center justify-center mb-6 border border-white/10 shadow-inner">
                                      <CalendarDays className="w-6 h-6 text-white" />
                                  </div>
                                  <h3 className="text-2xl font-black text-white leading-none uppercase tracking-tighter">Exam<br/>Routine</h3>
                              </div>
                              <div className="relative z-10 flex items-center gap-3 text-[10px] font-black text-blue-100 uppercase tracking-[0.2em] group-hover:text-white transition-colors">
                                  Track Schedule <ArrowRight className="w-4 h-4" />
                              </div>
                          </Link>

                          <Link href={`/resources/${segment_slug}?type=update&category=Syllabus`} className="relative group overflow-hidden rounded-[2.5rem] p-8 flex flex-col justify-between h-52 bg-gradient-to-br from-emerald-500 to-teal-700 shadow-2xl shadow-emerald-500/20 hover:-translate-y-2 transition-all duration-500">
                              <div className="absolute right-[-20px] bottom-[-20px] opacity-10 transform rotate-12 group-hover:scale-125 group-hover:rotate-0 transition-all duration-700">
                              ...
                              <div className="relative z-10">
                                  ...
                                  <h3 className="text-2xl font-black text-white leading-none uppercase tracking-tighter">Full<br/>Syllabus</h3>
                              </div>
                              <div className="relative z-10 flex items-center gap-3 text-[10px] font-black text-emerald-100 uppercase tracking-[0.2em] group-hover:text-white transition-colors">
                                  Curriculums <ArrowRight className="w-4 h-4" />
                              </div>
                          </Link>

                          <Link href={`/resources/${segment_slug}?type=update&category=Result`} className="relative group overflow-hidden rounded-[2.5rem] p-8 flex flex-col justify-between h-52 bg-gradient-to-br from-amber-500 to-orange-700 shadow-2xl shadow-amber-500/20 hover:-translate-y-2 transition-all duration-500">
                              <div className="absolute right-[-20px] bottom-[-20px] opacity-10 transform rotate-12 group-hover:scale-125 group-hover:rotate-0 transition-all duration-700">
                              ...
                              <div className="relative z-10">
                                  ...
                                  <h3 className="text-2xl font-black text-white leading-none uppercase tracking-tighter">Board<br/>Results</h3>
                              </div>
                              <div className="relative z-10 flex items-center gap-3 text-[10px] font-black text-amber-100 uppercase tracking-[0.2em] group-hover:text-white transition-colors">
                                  Achievement <ArrowRight className="w-4 h-4" />
                              </div>
                          </Link>
                      </div>
                  </section>
                  ...
                  <section>
                      <div className="flex items-center justify-between mb-10 gap-6">
                          <div className="flex items-center gap-4">
                              ...
                              <h2 className="text-3xl font-black uppercase tracking-tighter">Expert Insights</h2>
                          </div>
                          <Link 
                              ...
                              {blogs.map((blog: any) => (
                                  ...
                                  >
                                      <div className="h-56 relative overflow-hidden">
                                          {blog.content_url ? (
                                              ...
                                              <div className="w-full h-full flex flex-col items-center justify-center p-8 bg-slate-100 dark:bg-slate-800">
                                                  ...
                                                  <h3 className="text-slate-400 dark:text-slate-500 font-black text-center text-sm uppercase tracking-widest leading-relaxed">{blog.title}</h3>
                                              </div>
                                          )}
                                      ...
                                      <div className="p-8 flex-1 flex flex-col">
                                          <h3 className="font-black text-2xl text-slate-900 dark:text-white mb-6 uppercase tracking-tight group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors line-clamp-2">{blog.title}</h3>
                                          <div className="flex items-center justify-between mt-auto pt-6 border-t border-slate-50 dark:border-slate-800">
                                              <span className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest">{new Date(blog.created_at).toLocaleDateString()}</span>
                                              <div className="w-10 h-10 rounded-xl bg-slate-50 dark:bg-slate-800 group-hover:bg-indigo-600 text-slate-400 dark:text-slate-500 group-hover:text-white flex items-center justify-center transition-all duration-300">
                  ...
                  <section>
                      <div className="flex items-center justify-between mb-10 gap-6 px-4">
                          <div className="flex items-center gap-4">
                              ...
                              <h2 className="text-3xl font-black uppercase tracking-tighter text-slate-900 dark:text-white">Study Vault</h2>
                          </div>
                          <Link href={`/resources/${segment_slug}?type=pdf`} className="px-6 py-3 bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-slate-900 hover:text-white transition-all duration-300">
                              Full Vault
                          </Link>
                      </div>
                              ...
                              {materials.map((item: any) => (
                                  <div key={item.id} className="group bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-2xl transition-all duration-500 flex items-center gap-6">
                                      ...
                                      <div className="flex items-center gap-4">
                                         ...
                                         />
                                         <Link href={`/material/${item.slug || item.id}`} className="px-6 py-3 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-xl text-[10px] font-black uppercase tracking-widest hover:scale-105 transition-all shadow-xl shadow-slate-900/20 hidden sm:block">
                  ...
                  <section id="question-bank">
                      <div className="flex items-center gap-4 mb-10 px-4">
                          ...
                          <div>
                              ...
                              <p className="text-[10px] text-slate-400 dark:text-slate-500 font-black uppercase tracking-[0.2em] mt-1">Institutional Archives</p>
                          </div>
                      </div>
                      ...
                      <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-xl overflow-hidden px-2">
                          {questions && questions.length > 0 ? (
                              <div className="flex flex-col divide-y divide-slate-50 dark:divide-slate-800">
                                  {questions.map((q: any) => (
                                      <Link href={`/question/${q.slug || q.id}`} key={q.id} className="flex flex-col md:flex-row md:items-center gap-6 p-8 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-all duration-300 group">
                                          ...
                                          <div className="flex-1 min-w-0">
                                              <h3 className="font-black text-slate-800 dark:text-white text-lg group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors uppercase tracking-tight truncate mb-2">{q.title}</h3>
                                              <div className="flex items-center gap-4">
                                          ...
                                          <div className="flex items-center gap-6">
                                             ...
                                             />
                                             <div className="w-10 h-10 rounded-xl bg-slate-50 dark:bg-slate-800 text-slate-300 dark:text-slate-600 group-hover:bg-indigo-600 group-hover:text-white flex items-center justify-center transition-all duration-300">
                                                  <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                                             </div>
                                          </div>
                                      </Link>
                                  ))}
                                  <Link href={`/resources/${segment_slug}?type=question`} className="text-center py-6 text-[10px] font-black text-slate-400 dark:text-slate-500 hover:text-indigo-600 hover:bg-indigo-50 dark:hover:bg-indigo-950/20 transition-all uppercase tracking-[0.2em]">
