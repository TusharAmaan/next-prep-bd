                ...
                <div className="relative z-10 space-y-10">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-start gap-4 group">
                            ...
                            <div>
                                ...
                                <a href="mailto:nextprepbd@gmail.com" className="text-lg font-medium text-white hover:text-blue-400 transition">nextprepbd@gmail.com</a>
                            </div>
                        </div>
                    ...
                    <div className="border-t border-white/10 pt-8">
                        ...
                        <div className="flex gap-3">
                            <a href="https://www.facebook.com/profile.php?id=61584943876571" className="flex items-center gap-2 px-4 py-2 bg-[#1877F2] hover:bg-blue-600 text-white rounded-lg text-sm font-bold transition shadow-lg shadow-blue-500/20">
                                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                                Facebook
                            </a>
                            <a href="https://www.youtube.com/@nextprepbd" className="flex items-center gap-2 px-4 py-2 bg-[#FF0000] hover:bg-red-600 text-white rounded-lg text-sm font-bold transition shadow-lg shadow-red-500/20">
