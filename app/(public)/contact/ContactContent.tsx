  ...
  return (
    <div className="max-w-7xl w-full mx-auto px-6">
      ...
      <div className="text-center mb-24 max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-100 dark:border-indigo-800 text-indigo-600 dark:text-indigo-400 font-bold text-[10px] uppercase tracking-widest mb-8">
            <Sparkles className="w-4 h-4" /> Leading Educational Support
          </div>
          <h1 className="text-5xl md:text-8xl font-bold text-slate-900 dark:text-white mb-8 tracking-tight leading-[0.9]">
            Contact Our <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-cyan-500">Support Team.</span>
          </h1>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-[3rem] shadow-3xl dark:shadow-none border border-slate-100 dark:border-slate-800 overflow-hidden grid grid-cols-1 lg:grid-cols-12 transition-colors duration-500">
          ...
          <div className="lg:col-span-5 bg-slate-900 dark:bg-slate-950 text-white p-12 md:p-16 flex flex-col justify-between relative overflow-hidden group">
              ...
              <div className="relative z-10 space-y-16">
                  <div>
                      <h3 className="text-3xl font-bold mb-4 tracking-tight">Support <span className="text-indigo-500">Channels</span></h3>
                      <p className="text-slate-400 text-sm font-semibold tracking-wide leading-loose opacity-60">We typically respond within <br/>2 hours during business hours.</p>
                  </div>
                  ...
                  <div className="space-y-10">
                      ...
                      <div className="flex items-start gap-6 group/item">
                          ...
                          <div>
                              <h4 className="font-bold text-[9px] text-slate-500 uppercase tracking-widest mb-2">Email Us</h4>
                              <a href="mailto:nextprepbd@gmail.com" className="text-xl font-bold text-white hover:text-indigo-400 transition-colors tracking-tight">nextprepbd@gmail.com</a>
                          </div>
                      </div>
                      ...
                      <div className="flex items-start gap-6 group/item">
                          ...
                          <div>
                              <a href="https://wa.me/8801619663933">
                                  <h4 className="font-bold text-[9px] text-slate-500 uppercase tracking-widest mb-2">WhatsApp / Phone</h4>
                                  <p className="text-xl font-bold text-white hover:text-emerald-400 transition-colors cursor-pointer tracking-tight">+880 16196 63933</p>
                              </a>
                          </div>
                      </div>
                  ...
                  <div className="pt-16 border-t border-white/5 space-y-8">
                      ...
                      <div className="flex flex-wrap gap-4">
                          <a href="https://www.facebook.com/profile.php?id=61584943876571" className="flex items-center gap-4 px-8 py-4 bg-white/5 hover:bg-[#1877F2] text-white rounded-2xl text-[10px] font-bold uppercase tracking-widest transition-all duration-500 border border-white/5 hover:border-transparent group/btn">
                              <Facebook className="w-5 h-5 group-hover/btn:scale-125 transition-transform" />
                              Facebook
                          </a>
                          <a href="https://www.youtube.com/@nextprepbd" className="flex items-center gap-4 px-8 py-4 bg-white/5 hover:bg-[#FF0000] text-white rounded-2xl text-[10px] font-bold uppercase tracking-widest transition-all duration-500 border border-white/5 hover:border-transparent group/btn">
          ...
          <div className="lg:col-span-7 p-12 md:p-16 flex flex-col justify-center">
              <h3 className="text-3xl font-bold text-slate-900 dark:text-white mb-10 tracking-tight leading-none uppercase">Send Us <br/><span className="text-indigo-600 dark:text-indigo-400">A Message</span></h3>
