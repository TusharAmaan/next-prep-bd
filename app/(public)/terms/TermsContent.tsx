  ...
  const metaCards = [
    {
      ...
      desc: "All resources are for personal educational use. Commercial exploitation is strictly prohibited.",
      icon: Scale,
    ...
    },
    {
      ...
      desc: "Users must adhere to the high-performance conduct protocol within our digital ecosystem.",
      icon: ShieldCheck,
      color: "text-blue-600",
      bg: "bg-blue-50"
    },
    {
      ...
      desc: "Copyright and technical notations on all academic assets must remain intact.",
      icon: FileWarning,
    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="text-center mb-32">
        <div className="inline-flex items-center gap-3 py-2 px-6 rounded-full bg-slate-900 text-white dark:bg-indigo-600 text-[10px] font-black uppercase tracking-[0.3em] mb-12 shadow-2xl">
          <Gavel className="w-4 h-4 text-indigo-400" /> Authorized Governance Protocol
        </div>
        <h1 className="text-5xl md:text-9xl font-black text-slate-900 dark:text-white mb-10 tracking-tighter uppercase leading-[0.85]">
          Terms of <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-violet-600 to-cyan-500">Service.</span>
        </h1>
        <p className="text-lg md:text-xl text-slate-500 dark:text-slate-400 font-medium max-w-2xl mx-auto">
          Synchronizing user interaction with our high-performance academic ecosystem. Last Update: <span className="text-slate-900 dark:text-white font-black">{lastUpdated}</span>
        </p>
      </div>
      ...
      <div className="space-y-16">
        ...
        <section className="bg-white dark:bg-slate-900/50 p-12 md:p-20 rounded-[4rem] border border-slate-100 dark:border-slate-800 relative group overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row gap-12 relative z-10">
            ...
            <div className="space-y-8">
              <h2 className="text-3xl md:text-5xl font-black text-slate-900 dark:text-white uppercase tracking-tighter leading-none">Agreement <br/> Acceptance</h2>
              <div className="space-y-6 text-slate-600 dark:text-slate-400 font-medium text-lg leading-relaxed">
                <p>By accessing or synchronizing with <span className="text-slate-900 dark:text-white font-black uppercase">NextPrepBD</span>, you acknowledge full acceptance of these terms. If you do not agree to these parameters, disconnect from the ecosystem immediately.</p>
                <div className="p-8 rounded-[2rem] bg-amber-50 dark:bg-amber-900/10 border border-amber-100 dark:border-amber-800 flex items-start gap-6">
                  ...
                  <p className="text-sm font-black uppercase text-amber-800 dark:text-amber-500 tracking-tight leading-relaxed">Jurisdiction: These terms are governed by the laws of the People's Republic of Bangladesh. Disputes are subject to the exclusive jurisdiction of the Dhaka courts.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="bg-slate-900 text-white p-12 md:p-20 rounded-[4rem] border border-white/5 relative group overflow-hidden shadow-3xl">
          ...
          <div className="flex flex-col md:flex-row gap-12 relative z-10">
            ...
            <div className="space-y-8">
              <h2 className="text-3xl md:text-5xl font-black text-white uppercase tracking-tighter leading-none">Intelligence <br/> <span className="text-indigo-400">Property</span></h2>
              <div className="space-y-8 text-slate-400 font-medium text-lg leading-relaxed">
                <p>All academic assets, including code, text, graphics, and logos, are the property of NextPrepBD and protected by international intellectual property laws.</p>
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {[
                    "No Commercial Redistribution",
                    "No Mechanical Automation (Scraping)",
                    "No Mirroring of Ecosystem Nodes",
                    "No Tampering with Security Protocol"
                  ].map((rule, id) => (
        ...
        <section className="bg-white dark:bg-slate-900/50 p-12 md:p-20 rounded-[4rem] border border-slate-100 dark:border-slate-800 relative group overflow-hidden">
          <div className="flex flex-col md:flex-row gap-12 relative z-10">
            <div className="w-20 h-20 shrink-0 bg-cyan-600 text-white rounded-[2rem] flex items-center justify-center text-2xl font-black shadow-3xl">03</div>
            <div className="space-y-8">
              <h2 className="text-3xl md:text-5xl font-black text-slate-900 dark:text-white uppercase tracking-tighter leading-none">Ecosystem <br/> Disclaimer</h2>
              <div className="space-y-6 text-slate-600 dark:text-slate-400 font-medium text-lg leading-relaxed">
                <p>THE SERVICES ARE PROVIDED "AS IS" WITHOUT WARRANTIES OF ANY KIND. NextPrepBD does not guarantee the absolute accuracy of academic assets, though we strive for maximum precision. We are not liable for any specific examination outcomes.</p>
                <div className="flex gap-4 p-6 rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700">
                  ...
                  <p className="text-[11px] font-black uppercase tracking-widest leading-relaxed">Continuous Optimization: We reserve the right to modify any intelligence node or service protocol without prior notification.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="pt-20">
           <div className="bg-slate-900 dark:bg-indigo-600 rounded-[4rem] p-12 md:p-24 text-white relative overflow-hidden shadow-3xl group text-center">
              ...
              <div className="relative z-10 max-w-4xl mx-auto space-y-12">
                <h2 className="text-4xl md:text-7xl font-black leading-[0.9] tracking-tighter uppercase">Legal <br /> Synchronicity.</h2>
                <p className="text-xl md:text-2xl text-indigo-100/70 font-medium leading-relaxed">
                   Our legal response team oversees the ethical use of our academic ecosystem.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-8 justify-center">
                   <a href="mailto:nextprepbd@gmail.com" className="flex items-center gap-6 p-6 pr-12 bg-white text-slate-900 rounded-[2.5rem] transition-all group/btn shadow-2xl hover:bg-slate-50 active:scale-95">
                      ...
                      <div className="text-left">
                         <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">Inquiry Relay</p>
                         <p className="text-xl font-black uppercase tracking-tight">Legal Hub</p>
                      </div>
                   </a>
                   <a href="https://wa.me/8801619663933" className="flex items-center gap-6 p-6 pr-12 bg-white/10 hover:bg-white/20 rounded-[2.5rem] border border-white/20 transition-all group/btn backdrop-blur-xl active:scale-95">
                      ...
                      <div className="text-left">
                         <p className="text-[10px] font-black uppercase tracking-widest text-indigo-200 mb-1">Signal Protocol</p>
