      ...
      <div className="bg-gray-900 text-white py-12 md:py-16 px-6">
        <div className="max-w-7xl mx-auto md:flex gap-10 items-center">
            <div className="md:w-2/3">
                <div className="inline-block bg-blue-600 text-[10px] font-black uppercase tracking-widest px-4 py-1.5 rounded-full mb-6">
        ...
        <div className="lg:col-span-2 py-12 space-y-16">
            ...
            <div className="space-y-8">
                <div className="flex items-center justify-between">
                    <h3 className="text-2xl font-black text-slate-900 uppercase tracking-tight italic">Curriculum</h3>
                    <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest bg-slate-100 px-3 py-1 rounded-full">{lessons.length} Modules</span>
                </div>
                ...
                <div className="bg-white rounded-[3rem] shadow-2xl border border-slate-100 overflow-hidden transform -translate-y-20 md:translate-y-0 p-4">
                    <div className="aspect-video bg-slate-900 rounded-[2.5rem] relative overflow-hidden group shadow-inner">
                        {course.thumbnail_url ? (
                            ...
                            <div className="w-full h-full flex items-center justify-center text-slate-700 font-black flex-col gap-4">
                                ...
                                <span className="uppercase tracking-widest text-xs opacity-40">No Preview</span>
                            </div>
                        )}
                    ...
                    <div className="p-8">
                        ...
                        <p className="text-[10px] font-black text-slate-400 text-center mt-6 uppercase tracking-widest">Premium Learning Access</p>

                        <div className="mt-10 space-y-6 pt-8 border-t border-slate-50">
                            <h4 className="text-[10px] font-black text-slate-900 uppercase tracking-[0.2em]">Course Perks</h4>
                            <ul className="space-y-4">
                                {[
                                    ...
                                    <li key={i} className="flex items-center gap-4 group">
                                        ...
                                        <span className="text-xs font-bold text-slate-600 uppercase tracking-tight">{perk.text}</span>
                                    </li>
                                ))}
                            </ul>
                        </div>
