...
import { Printer, ArrowLeft, ShieldAlert, Loader2, FileText, Home } from "lucide-react";
  ...
  useEffect(() => {
    ...
    const fetchExam = async () => {
        try {
            ...
            // 3. Simple Fetch (No complex logic, just get the row)
            ...
            setErrorMessage(err.message || "Failed to load exam.");
            setStatus('error');
        }
    };
