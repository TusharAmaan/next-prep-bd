...
export default function ThreadMainPost({ 
  ...
  return (
    <div className="bg-white dark:bg-[#1C1F26] rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 p-6 sm:p-8 text-left">
      ...
      {/* Author & Kudos Banner */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-50/50 dark:bg-slate-800/25 p-4 rounded-2xl border border-slate-200/40 dark:border-slate-800/40 mb-6">
          ...
          <button 
            ...
            className={`flex items-center justify-center gap-1.5 px-4 py-2 rounded-xl border text-xs font-black transition-all active:scale-95 shadow-sm ${
              isUpvoted 
                ...
                : 'bg-white hover:bg-slate-50 dark:bg-[#1C1F26] dark:hover:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 hover:text-blue-600 hover:border-blue-600/30'
            }`}
          >
          ...
          <button 
            ...
            className={`flex items-center justify-center gap-1.5 px-4 py-2 rounded-xl border text-xs font-black transition-all active:scale-95 shadow-sm ${
              isSaved 
                ...
                : 'bg-white hover:bg-slate-50 dark:bg-[#1C1F26] dark:hover:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 hover:text-indigo-600 hover:border-indigo-600/30'
            }`}
          >
