  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const { data: blogData } = await supabase
        ...
        .limit(5);
      if (blogData) setRecentPosts(blogData);
    };
    fetchData();
  }, []);
  ...
  return (
    <aside className="space-y-8">
      ...
      <div className="bg-[#1877F2] rounded-2xl shadow-lg p-6 text-white relative overflow-hidden group">
        ...
        <p className="text-blue-100 text-xs mb-4 relative z-10">Get daily updates on Facebook.</p>
      ...
      <div className="bg-[#FF0000] rounded-2xl shadow-lg p-6 text-white relative overflow-hidden group">
        ...
        <p className="text-red-100 text-xs mb-4 relative z-10">Subscribe for video tutorials.</p>
